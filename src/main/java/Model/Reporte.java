...
public static void ReporteCotizaciones() {
        ...
        try {
            ...
            try {
                ...
                String sql = "SELECT gi.fecha_registro AS fecha_registro_ingreso, " +
                        ...
                        "ORDER BY fecha_registro_ingreso ASC";
	...
	public static void ReportePLanilla() {
	    ...
	    try {
	        ...
	        float[] columnsWidths = {8, 15, 12, 12, 12, 12}; // Adjusted columns for Planilla
	        ...
	        try {
	            Connection cn = Conexion.obtenerConexion();
	            PreparedStatement pst = cn.prepareStatement(
	                    "SELECT c.id, e.nombres, c.sueldo_mensual, c.gratificacion, c.cts, c.fecha_registro " +
	                            "FROM contrato c " +
	                            "JOIN empleado e ON c.id_empleado = e.id");
	            ResultSet rs = pst.executeQuery();
	            while (rs.next()) {
	                ...
	                tabla.addCell(String.valueOf(rs.getDouble(5)));	                
	                tabla.addCell(String.valueOf(rs.getString(6)));	                
	            }
